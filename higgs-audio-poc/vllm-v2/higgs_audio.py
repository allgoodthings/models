...
def get_processor(
    ...
    **kwargs,
    ...
    # Determine if this is an audio output model based on tokenizer type
    # Audio output models use bosonai/higgs-audio-v2-tokenizer (or similar)
    # Audio input models use openai/whisper-large-v3-turbo
    is_audio_out_model = HIGGS_AUDIO_TOKENIZER != "openai/whisper-large-v3-turbo"
